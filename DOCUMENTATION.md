...
| 4 | Feature 1: Arbitrage Calculator & Pricing Logic | Design and implementation of core arbitrage calculation engine, net profit comparison across districts, freight cost integration, live vs fallback price logic | Priyanshu Reddy | Adithya Bontha |
...
| 8 | Testing and quality assurance | Field testing with 14 rice merchants across AP/Telangana, failure case identification (price trust, mobile UX, marginal confusion), feature fixes based on testing, accuracy validation against actual mandi prices | Adithya Bontha| Adithya Bontha |
